var DOQ = DOQ || (function() {

    var editorInitialized = false;
    var dataStore = {};

    var allowedElements = [
        'H1', 'H2', 'H3', 'SPAN', 'P', 'STRONG', 'PRE', 'FONT'
    ];
    ...
    return {
        init: function(args) {
            ...
            if (typeof args.debug !== 'undefined') {
                ...
                getAnnotationsUrl = 'http://localhost:8080/getAnnotations';
                saveAnnotationUrl = 'http://localhost:8080/saveAnnotation';
            }
